    ...
    foreach (phphoto_db_query($db, $sql) as $row) {
        array_push($images, array(
            ...
            "<a href='".CURRENT_PAGE.'?'.
                    ...
                    GET_KEY_GALLERY_ID.'='.$gallery_id.'&'.
                    GET_KEY_IMAGE_ID."=$row[id]'><img src='".GALLERY_THEME_PATH."remove.png'></a>"
        ));
    }
...
function phphoto_echo_admin_galleries($db) {
    ...
    foreach (phphoto_db_query($db, $sql) as $row) {
        array_push($data, array(
            ...
            $row['images'],
            ((!$row['images']) ? "<a href='".CURRENT_PAGE.'?'.GET_KEY_ADMIN_QUERY.'='.GET_VALUE_ADMIN_GALLERY.'&'.GET_KEY_OPERATION.'='.GET_VALUE_DELETE.'&'.GET_KEY_GALLERY_ID."=$row[id]'><img src='".GALLERY_THEME_PATH."remove.png'></a>" : "<img src='".GALLERY_THEME_PATH."remove_disabled.png'>")
        ));
    }
    ...
    if ($page_number > 0)
        echo "<a href='".CURRENT_PAGE.'?'.GET_KEY_ADMIN_QUERY.'='.GET_VALUE_ADMIN_GALLERY.'&'.GET_KEY_PAGE_NUMBER.'='.($page_number - 1)."'><img src='".GALLERY_THEME_PATH."prev.png'></a>";
    else
        echo "<img src='".GALLERY_THEME_PATH."prev_disabled.png'>";
    echo "&nbsp;".($page_number + 1)." (of $pages)&nbsp;";
    if ($page_number < ($pages - 1))
        echo "<a href='".CURRENT_PAGE.'?'.GET_KEY_ADMIN_QUERY.'='.GET_VALUE_ADMIN_GALLERY.'&'.GET_KEY_PAGE_NUMBER.'='.($page_number + 1)."'><img src='".GALLERY_THEME_PATH."next.png'></a>";
    else
        echo "<img src='".GALLERY_THEME_PATH."next_disabled.png'>";
...
function phphoto_echo_admin_images($db) {
    ...
    foreach (phphoto_db_query($db, $sql) as $row) {
        array_push($data, array(
            ...
            $row['views']." (".round($row['popularity']*100)."%)",
            ((!$row['in_use']) ? "<a href='".CURRENT_PAGE.'?'.GET_KEY_ADMIN_QUERY.'='.GET_VALUE_ADMIN_IMAGE.'&'.GET_KEY_OPERATION.'='.GET_VALUE_DELETE.'&'.GET_KEY_IMAGE_ID."=$row[id]'><img src='".GALLERY_THEME_PATH."remove.png'></a>" : "<img src='".GALLERY_THEME_PATH."remove_disabled.png'>")
        ));
    }
    ...
    if ($page_number > 0)
        echo "<a href='".CURRENT_PAGE.'?'.GET_KEY_ADMIN_QUERY.'='.GET_VALUE_ADMIN_IMAGE.'&'.GET_KEY_PAGE_NUMBER.'='.($page_number - 1)."'><img src='".GALLERY_THEME_PATH."prev.png'></a>";
    else
        echo "<img src='".GALLERY_THEME_PATH."prev_disabled.png'>";
    echo "&nbsp;".($page_number + 1)." (of $pages)&nbsp;";
    if ($page_number < ($pages - 1))
        echo "<a href='".CURRENT_PAGE.'?'.GET_KEY_ADMIN_QUERY.'='.GET_VALUE_ADMIN_IMAGE.'&'.GET_KEY_PAGE_NUMBER.'='.($page_number + 1)."'><img src='".GALLERY_THEME_PATH."next.png'></a>";
    else
        echo "<img src='".GALLERY_THEME_PATH."next_disabled.png'>";
