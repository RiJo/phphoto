...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 10, 2010 at 03:20 AM
...
--
-- Constraints for table `image_to_category`
--
ALTER TABLE `image_to_category`
  ADD CONSTRAINT `image_to_category_ibfk_2` FOREIGN KEY (`image_id`) REFERENCES `images` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `image_to_category_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
