...
('en', 'common', 'no_exif_data', '(no exif data)', 0, NOW(), NOW()),
...
('en', 'gallery', 'empty_title', 'Could not create gallery without title', 0, NOW(), NOW()),
...
('en', 'header', 'active', 'Active', 0, NOW(), NOW()),
...
('en', 'tag', 'empty_name', 'Could not create tag without name', 0, NOW(), NOW()),
...
('se', 'common', 'no_exif_data', '(ingen exif data)', 0, NOW(), NOW()),
...
('se', 'gallery', 'empty_title', 'Kunde inte skapa galleri utan titel', 0, NOW(), NOW()),
...
('se', 'header', 'active', 'Aktiv', 0, NOW(), NOW()),
...
('se', 'tag', 'empty_name', 'Kunde inte skapa tagg utan namn', 0, NOW(), NOW()),
